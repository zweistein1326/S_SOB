...
const FeedCard = (props:any) => {
    ...
    return(
        <Grid item key={props.key} style={{margin:'2rem 0', height:'60vh', minWidth:'30vw', border:'2px solid white',position:'relative', borderRadius:'0px', backgroundColor:'#EEEEEE', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center'}}>
            ...
            <Box style={{position:'absolute', bottom:0, right:0, height:'20%', width:'20%', display:'flex', alignItems:'center', justifyContent:'center'}}>
