    ...
    return(
        commenter ? <Box component="div" style={{display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'space-between', padding:'5px', width:'100%'}}>
            <Box component="div" style={{display:'flex', flexDirection:'row', alignItems:'center'}}>
                {commenter.profileImageUrl? <img src={commenter.profileImageUrl } style={{height:'40px', border:'2px solid #02F9A7', width:'40px', borderRadius:'50%'}}/> : <Box component="div" style={{backgroundColor:'darkGreen',objectFit:'cover', width:'40px', height:'40px', margin:'10px', borderRadius:'50%'}}></Box> }
