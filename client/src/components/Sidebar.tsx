...
const Sidebar = (props:any) => {
    return (
        <Box style={{position:'relative', zIndex:'999999', height:'100vh', backgroundColor:'#EEEEEE', width:'15vw', display:'flex', flexDirection:'column', alignItems:'center'}}>
            <Box style={{padding:'20px 10px',borderRadius:'30px', margin:'10px 0px', backgroundColor:'#000000', width:'90%', display:'flex', justifyContent:'center'}}>
            ...
            <Box style={{padding:'20px 10px',borderRadius:'30px', margin:'10px 0px', backgroundColor:'#000000', width:'90%', display:'flex', justifyContent:'center'}}>
                <Link to='/' onClick={()=>{}} style={{textDecoration:'none', color:'#02F9A7'}}>Logout</Link>
            </Box>
